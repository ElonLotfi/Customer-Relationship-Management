...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('QR3sHFb2-J', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Wi33f99glE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () {
            ...
            yield 8 => ($this->privates['webpack_encore.entrypoint_lookup.cache_warmer'] ?? $this->getWebpackEncore_EntrypointLookup_CacheWarmerService());
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.view', [0 => function () {
            return ($this->privates['App\\Events\\CustomerUserSubscriber'] ?? $this->getCustomerUserSubscriberService());
        }, 1 => 'getConnectedUser'], 65);
        $instance->addListener('kernel.view', [0 => function () {
            return ($this->privates['App\\Events\\InvoiceChronoSubscriber'] ?? $this->getInvoiceChronoSubscriberService());
        }, 1 => 'incrementChrono'], 65);
        $instance->addListener('kernel.view', [0 => function () {
            return ($this->privates['App\\Events\\PasswordEncoderSubscriber'] ?? $this->getPasswordEncoderSubscriberService());
        }, 1 => 'encodePassword'], 33);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    protected function getNelmioApiDoc_Generator_DefaultService()
    {
        ...
        $this->services['nelmio_api_doc.generator.default'] = $instance = new \Nelmio\ApiDocBundle\ApiDocGenerator(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['nelmio_api_doc.describers.swagger_php.default'] ?? $this->getNelmioApiDoc_Describers_SwaggerPhp_DefaultService());
    ...
    protected function getSerializerService()
    {
        ...
        $e = ($this->privates['api_platform.metadata.property.name_collection_factory.cached'] ?? $this->getApiPlatform_Metadata_Property_NameCollectionFactory_CachedService());
        $f = ($this->privates['api_platform.metadata.property.metadata_factory.cached'] ?? $this->getApiPlatform_Metadata_Property_MetadataFactory_CachedService());
        $g = ($this->privates['api_platform.resource_class_resolver'] ?? $this->getApiPlatform_ResourceClassResolverService());
        $h = ($this->privates['api_platform.iri_converter'] ?? $this->getApiPlatform_IriConverterService());
        $i = ($this->privates['api_platform.jsonld.context_builder'] ?? $this->getApiPlatform_Jsonld_ContextBuilderService());
        $j = ($this->privates['property_accessor'] ?? $this->getPropertyAccessorService());
        $k = ($this->privates['serializer.mapping.class_metadata_factory'] ?? $this->getSerializer_Mapping_ClassMetadataFactoryService());
        $l = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($k, $c, $j, ($this->privates['property_info'] ?? $this->getPropertyInfoService()), new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($k), NULL, []);

        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => $a, 1 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($b, [], $c), 2 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $c), 3 => $a, 4 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($d, $e, $f, $g, NULL, $b, ($this->privates['api_platform.subresource_operation_factory.cached'] ?? $this->getApiPlatform_SubresourceOperationFactory_CachedService()), $c), 5 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($d, $h, $b), 6 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($b, true), 7 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), 8 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 9 => new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($d, $e, $f, $h, $g, $i, $j, $c, $k, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), false), 10 => new \ApiPlatform\Core\Serializer\ItemNormalizer($e, $f, $h, $g, $j, $c, $k, ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $d, false), 11 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 12 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 13 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $c), 14 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 15 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 16 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 17 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($i, $g, $h), 'page', 'pagination', $d, $j), $d, $g, ($this->privates['api_platform.filter_locator'] ?? $this->getApiPlatform_FilterLocatorService())), 18 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 19 => new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($l, $h, $i), 20 => $l], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => new \Symfony\Component\Serializer\Encoder\JsonEncoder(), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    protected function getCurrentUserExtensionService()
    {
        ...
        return $this->privates['App\\Doctrine\\CurrentUserExtension'] = new \App\Doctrine\CurrentUserExtension(($this->privates['security.helper'] ?? $this->getSecurity_HelperService()), ($this->services['security.authorization_checker'] ?? $this->getSecurity_AuthorizationCheckerService()));
    }
     ...
     */
    protected function getCustomerUserSubscriberService()
    {
        include_once \dirname(__DIR__, 4).'/src/Events/CustomerUserSubscriber.php';

        return $this->privates['App\\Events\\CustomerUserSubscriber'] = new \App\Events\CustomerUserSubscriber(($this->privates['security.helper'] ?? $this->getSecurity_HelperService()));
    }
     ...
     */
    protected function getInvoiceChronoSubscriberService()
    {
        include_once \dirname(__DIR__, 4).'/src/Events/InvoiceChronoSubscriber.php';

        return $this->privates['App\\Events\\InvoiceChronoSubscriber'] = new \App\Events\InvoiceChronoSubscriber(($this->privates['security.helper'] ?? $this->getSecurity_HelperService()), ($this->privates['App\\Repository\\InvoiceRepository'] ?? $this->getInvoiceRepositoryService()));
    }
    ...
    protected function getPasswordEncoderSubscriberService()
    {
        ...
        return $this->privates['App\\Events\\PasswordEncoderSubscriber'] = new \App\Events\PasswordEncoderSubscriber(($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));
    }
     ...
     */
    protected function getAnnotatedAppEntityCustomerApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService()
    {
        ...
        return $this->privates['annotated_app_entity_customer_api_platform_core_bridge_doctrine_orm_filter_search_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\SearchFilter(($this->services['doctrine'] ?? $this->getDoctrineService()), NULL, ($this->privates['api_platform.iri_converter'] ?? $this->getApiPlatform_IriConverterService()), ($this->privates['property_accessor'] ?? $this->getPropertyAccessorService()), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ['firstname' => 'partial', 'lastname' => NULL, 'company' => NULL], ($this->privates['api_platform.identifiers_extractor.cached'] ?? $this->getApiPlatform_IdentifiersExtractor_CachedService()), ($this->privates['serializer.name_converter.metadata_aware'] ?? $this->getSerializer_NameConverter_MetadataAwareService()));
    }
     ...
     */
    protected function getAnnotatedAppEntityInvoiceApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/Api/FilterInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/Bridge/Doctrine/Orm/Filter/FilterInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/Bridge/Doctrine/Common/PropertyHelperTrait.php';
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('t8SYJ0UJe3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('s1j1Xa1OSO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Gbi6QIQhTu', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getApiPlatform_Doctrine_Orm_Default_CollectionDataProviderService()
    {
        ...
        return $this->privates['api_platform.doctrine.orm.default.collection_data_provider'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\CollectionDataProvider(($this->services['doctrine'] ?? $this->getDoctrineService()), new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Doctrine\\CurrentUserExtension'] ?? $this->getCurrentUserExtensionService());
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'annotated_app_entity_customer_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_customer_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityCustomerApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', false],
            'annotated_app_entity_invoice_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_invoice_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityInvoiceApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService', false],
        ], [
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jBqTn6bMNO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9zfR0Zp10o', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5DuqWIkxTn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MlqurmV4Xj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lXwtIG4QER', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('X60TNclmsc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getNelmioApiDoc_ModelDescribers_FormService()
    {
        ...
        return $this->privates['nelmio_api_doc.model_describers.form'] = new \Nelmio\ApiDocBundle\ModelDescriber\FormModelDescriber(($this->services['form.factory'] ?? $this->getForm_FactoryService()));
    }
    ...
    /**
     * Gets the private 'security.authentication.listener.anonymous.signup' shared service.
     *
     * @return \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener
     */
    protected function getSecurity_Authentication_Listener_Anonymous_SignupService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-http/Firewall/AbstractListener.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-http/Firewall/ListenerInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-http/Firewall/LegacyListenerTrait.php';
        ...
        return $this->privates['security.authentication.listener.anonymous.signup'] = new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), $this->getParameter('container.build_hash'), ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()), ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()));
    }
    ...
    protected function getSecurity_Authentication_Listener_Guard_ApiService()
    {
        ...
        $a = new \Symfony\Component\Security\Guard\GuardAuthenticatorHandler(($this->services['security.token_storage'] ?? $this->getSecurity_TokenStorageService()), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()), [0 => 'signup', 1 => 'login', 2 => 'api']);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.authentication.provider.anonymous.signup'] ?? ($this->privates['security.authentication.provider.anonymous.signup'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
            yield 1 => ($this->privates['security.authentication.provider.dao.login'] ?? $this->getSecurity_Authentication_Provider_Dao_LoginService());
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.signup' => ['privates', 'security.firewall.map.context.signup', 'getSecurity_Firewall_Map_Context_SignupService', false],
        ], [
            'security.firewall.map.context.api' => '?',
            'security.firewall.map.context.dev' => '?',
            'security.firewall.map.context.login' => '?',
            'security.firewall.map.context.main' => '?',
            'security.firewall.map.context.signup' => '?',
        ]), new RewindableGenerator(function () {
            yield 'security.firewall.map.context.dev' => ($this->privates['.security.request_matcher.Iy.T22O'] ?? ($this->privates['.security.request_matcher.Iy.T22O'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/')));
            yield 'security.firewall.map.context.signup' => ($this->privates['.security.request_matcher.1dWARN2'] ?? ($this->privates['.security.request_matcher.1dWARN2'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/users', NULL, [0 => 'POST'])));
    ...
    /**
     * Gets the private 'security.firewall.map.context.signup' shared service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext
     */
    protected function getSecurity_Firewall_Map_Context_SignupService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-bundle/Security/FirewallContext.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-http/Util/TargetPathTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-http/Firewall/ExceptionListener.php';
        ...
        return $this->privates['security.firewall.map.context.signup'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.channel_listener'] ?? $this->getSecurity_ChannelListenerService());
            yield 1 => ($this->privates['security.authentication.listener.anonymous.signup'] ?? $this->getSecurity_Authentication_Listener_Anonymous_SignupService());
            yield 2 => ($this->privates['security.access_listener'] ?? $this->getSecurity_AccessListenerService());
        }, 3), new \Symfony\Component\Security\Http\Firewall\ExceptionListener(($this->services['security.token_storage'] ?? $this->getSecurity_TokenStorageService()), ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver(NULL, NULL))), ($this->privates['security.http_utils'] ?? $this->getSecurity_HttpUtilsService()), 'signup', NULL, NULL, NULL, ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()), true), NULL, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('signup', 'security.user_checker', '.security.request_matcher.1dWARN2', true, true, 'security.user.provider.concrete.app_user_provider', NULL, NULL, NULL, NULL, [0 => 'anonymous'], NULL));
    }
